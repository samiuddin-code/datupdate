                ...
                <form autoComplete="off" method="post" onSubmit={(e) => e.preventDefault()} className={formSubmitting ? "pointer-events-none opacity-80" : ""}>
                    ...
                    <div className="mt-6">
                        <label>
                            ...
                            I have reviewed the <div className="underline" target="_blank" rel="noopener noreferrer" href="/terms-and-conditions">terms and conditions</div> and I agree to make this online payment.
                        </label>
                    </div>
                    {
                        formMessage &&
